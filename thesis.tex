...
% CHANGE NEXT LINE?
\documentclass[ece,thesis,letterpaper]{class/puthesis}
...
\pudegree{Master of Science in Electrical and Computer Engineering}{MSECE}{May}{2015}
% \pudegree{MSECE}
...
\include{chapters/ch-5}
\include{chapters/ch-6}
\include{chapters/ch-7}
\include{chapters/ch-8}
\include{chapters/ch-9}
% \include{chapters/before-december/cheating}
...
% CHANGE NEXT 7 LINES?
%\appendices
%\include{demo-files/citations}
%\include{demo-files/figures}
%\include{demo-files/mathematics}
%\include{demo-files/multicols}
%\include{demo-files/tables}
%\include{demo-files/text}
