...
\section{Aggregation-Commit Phase}
	...
	Talk about signatures of the \payloads.
	...
	We use the term \bs for the root of the \at and the \q for the trusted third party. In Figure \ref{fig:at} $A$ is the \bs and $Q$ is the \q.
