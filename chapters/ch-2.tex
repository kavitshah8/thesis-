...
\section{Sensor Networks and Applications}
	...
	\textbf{The Active Floor} \cite{addlesee1997orl} is a system which can detect person walking on it using pressure sensors.
	...
	Authors used Hidden Markov Models based analysis techniques originally developed for speech and face recognition.
	
	\textbf{CodeBlue} \cite{lorincz2004sensor} is a system to enhance emergency medical care with the goal to have a seamless patient transfer between a disaster area and a hospital.
	
	\textbf{Sustainable Mobility} - with the driver less cars from companies like Google, connected and coordinated vehicles seems the future of transportation.
...
\section{Energy Consumption}
	...
	The second is $\varepsilon_{amp} (J/m^2 b)$, the energy dissipated by the transmit power amplifier to achieve an acceptable noise ratio $E_{b} / N_{o} $ at the receiver.
