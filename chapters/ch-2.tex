...
\section{Security in In-network Data Aggregation}
	...
	\subsection{Hardware Limitations}
		Due to lower manufacturing cost of sensor nodes have low speed processor, limited storage, a short range trans receiver.
		For example, the latest specifications for a ZigBee chip supporting IEEE 802.15.4 standard, CC2538 from TexasInstruments are shown in Table \ref{table:soc}.
	\begin{table}[!htb]	
		\begin{center}
			\begin{tabular}{ |l| l| }
				\hline
	...
	\subsection{Mobility}
		Needs multi hop routing protocol,
		works on battery,
	\subsection{Transmission Medium}
		Wireless;
		collision or packet loss or cheating

	Because of the transmission between two out of range nodes has to rely on relay nodes, many routing protocols have been proposed for sensor networks. 
