...
\section{Sensor Node Architecture}
	...
	\textbf{Sensors} can be roughly categorized into three categories.
	...
	\textbf{The memory component} is fairly straightforward. 
...
\section{Data Aggregation in Sensor Networks}
