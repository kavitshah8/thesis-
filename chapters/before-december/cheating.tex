...
\section{Assumptions}
	...
	Without those two assumptions, there might be a lot of complainers in the network, creating a lot of traffic in the network.
...
\begin{exmp}
	This example shows the significance of the commitment field in the data-item format.
	Figure \ref{fig:cheating}  shows a commitment tree and the vertices have data-items defined as follows.\\
	\begin{figure}[t]
		\centering
