...
\section{Digital Signatures}
	...
	Note that the Digital Signature scheme satisfies the following requirements:
		...
		\end{itemize}
	The Figure \ref{fig:digita-signature} from shows the steps for signing and verifying the hashed message. 
	\begin{figure}[h!]
		\centering
	...
	\end{figure}
	The message is hashed before before its being signed to reduce the message size. 
