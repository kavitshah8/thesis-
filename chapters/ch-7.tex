...
\section{Data-Item}
	...
	The first difference between SHIA's label structure and our data-item structure is that we remove the $complement$ field from the label structure Definition \ref{def:label}. 
...
\section{Commitment Payload}
	...
	We define commitment payload based on the commitment forest Definition \ref{def:commitment-forest}.
