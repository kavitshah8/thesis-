...
\label{cha:A Protocol for Commitment Tree Generation}
	...
	Write about how SIA solves some of these.

	Write about how SHIA solves some of these.

	Write about why detecting malicious activity and detecting an adversary is an important aspect.
	...
	Consider the following example showing the analogy with the signature scheme used in practice by the postal services.
