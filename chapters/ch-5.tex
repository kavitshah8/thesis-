...
\section{Result checking} % (fold)
	...
	The purpose of the result checking phase is to enable each sensor node $I$ to independently verify that its data value as was added into the SUM aggregate, and the complement $(r - a_{s})$ of its data value was added into the COMPLEMENT aggregate. 
