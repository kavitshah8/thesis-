...
\section{Design Goals}	
	...
	It prevents masquerade attacks in the network so this protocol can easily be applied to do the voting scheme.
...
\section{Data-Item}
	...
	We describe structure of the data-item used in creating the commitment tree for the aggregate commit with verification approach, how it is different from the label structure of SHIA and rational behind it.	
	\begin{definition}
		\label{def:data-item}
