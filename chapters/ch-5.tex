...
\section{Motivation}	
	...
	We want to achieve all these desired security properties by inducing only $O(\delta \log^{k} n)$ node congestion in the aggregation tree; where $n$ is the number of nodes in the network, and $\delta$ is the fanout of any node in the aggregation tree.
